 ...
 * @author Xiloer
 */
public class ParticleEffectManager extends IManager {
    ...
    private ParticleEffectManager() {
        try {
            startParticleImg = imageManager.getscaleImageByScreenFromAssets("cannon/stars.png");
            goldStartParticleImg = imageManager.getscaleImageByScreenFromAssets("cannon/tenstar.png");
