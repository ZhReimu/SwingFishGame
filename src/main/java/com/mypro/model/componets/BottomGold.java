...
public class BottomGold extends Componet {
    ...
    public BottomGold(int layoutX, int layoutY) {
        try {
            initNum();
            pic = imageManager.getscaleImageByScreenFromAssets("componet/bottom_gold.png");
    ...
    private void initNum() {
        HashMap<String, Bitmap> allNum = imageManager.getImagesMapByImageConfig(
                imageManager.createImageConfigByPlist("componet/num_gold"),
